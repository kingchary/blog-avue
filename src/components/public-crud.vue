<template>
    <avue-crud :table-loading="dataComputed('tableLoading')"
               ...
               @search-change="(data,done)=>$provide.searchChange(data,done,true)"
    ...
    >
        ...
        <template v-for="i in tableSlots" :slot="i.prop"
              slot-scope="scope">
        ...
        <template v-for="i in formSlots" :slot="`${i.prop}Form`" slot-scope="scope" >
            <slot :name="`${i.prop}Form`" :row="scope.row">
...
export default {
    ...
    methods: {
        ...
        updatePage(pageInfo) {
            let providePageInfo=this.dataComputed('pageInfo')
            let {total,pageSize}=providePageInfo;
            Object.assign(pageInfo,{total,pageSize})
            /*Object.assign(providePageInfo, pageInfo)
    ...
    created() {
        ...
        console.log(this.formSlots, '=formSlots=')
    },
    mounted() {
